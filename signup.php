...
$message .= "http://tanyalr.host20.uk/NotesApp/activate.php?email=".urlencode($email)."&key=$activationKey";
...
//echo "<a href='http://tanyalr.host20.uk/NotesApp/activate.php?email=".urlencode($email)."&key=$activationKey'>$message</a>";
