...
//set the status to "used" in the forgotpassword table to prevent the key from being used twice
$sql = "UPDATE forgotpassword SET status='used' WHERE rkey='$key' AND user_id='$user_id'";
$result = mysqli_query($link, $sql);
if(!$result){
    echo '<div class="alert alert-danger">Error running the query.</div>';
}else{
	echo '<div class="alert alert-success">Your password has been updated successfuly. <a href="index.php">Login</a></div>';
}
